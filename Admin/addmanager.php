...
if(strlen($_REQUEST["uname"])==0 || strlen($_REQUEST["pass"])==0 || strlen($_REQUEST["email"])==0){
	...
	$sql="insert into user(`uname`, `firstname`, `lastname`, `password`, `email`, `phone`,`type`) values('".$_REQUEST["uname"]."','".$_REQUEST["firstname"]."','".$_REQUEST["lastname"]."','".$_REQUEST["pass"]."','".$_REQUEST["email"]."','".$_REQUEST["phone"]."','manager')";
...
<form action="addmanager.php" name="fm" method="post">
...
<body>
    ...
    <body>
        ...
        <div class="jumbotron text-center" style="margin-bottom:0">
            ...
            <h4> Create Manager Account </h4><br><br>
              ...
              <span class="navbar-toggler-icon"></span>
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="addagent.php">Add New Agent</a>
                            </li>
                            <li class="nav-item">
